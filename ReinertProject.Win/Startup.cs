...
public class ApplicationBuilder : IDesignTimeApplicationFactory {
    public static WinApplication BuildApplication(string connectionString) {
        ...
        builder.UseApplication<ReinertProjectWindowsFormsApplication>();
        builder.Modules
            .AddConditionalAppearance()
            .AddValidation(options => {
                options.AllowValidationDetailsAccess = false;
            })
            .Add<ReinertProject.Module.ReinertProjectModule>()
        	.Add<ReinertProjectWinModule>();
        ...
        builder.Security
            .UseIntegratedMode(options => {
                ...
                options.UserType = typeof(ReinertProject.Module.BusinessObjects.ApplicationUser);
                options.UserLoginInfoType = typeof(ReinertProject.Module.BusinessObjects.ApplicationUserLoginInfo);
