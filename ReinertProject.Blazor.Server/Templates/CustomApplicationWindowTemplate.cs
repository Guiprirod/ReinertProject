...
namespace ReinertProject.Blazor.Server.Templates
{
    public class CustomApplicationWindowTemplate : WindowTemplateBase, ISupportActionsToolbarVisibility, ISelectionDependencyToolbar, ISupportListEditorInlineActions, ISupportListEditorContextMenuActions
    {
        public CustomApplicationWindowTemplate()
        {
            ...
            HeaderToolbar.AddActionContainer(nameof(PredefinedCategory.Menu), ToolbarItemAlignment.Right);
